                  ...
                  <div class="col-lg-12 main-chart">
						...
						<table class="table table-stripped">
							...
							<tbody>
								...
								<tr>
									<td><input class="form-control" name="namatoko" value="<?php echo $toko['nama_toko'];?>" placeholder="Nama Cafe"></td>
									<td><input class="form-control" name="alamat" value="<?php echo $toko['alamat_toko'];?>" placeholder="Alamat Cafe"></td>
									<td><input class="form-control" name="kontak" value="<?php echo $toko['tlp'];?>" placeholder="Kontak (Hp)"></td>
									<td><input class="form-control" name="pemilik" value="<?php echo $toko['nama_pemilik'];?>" placeholder="Nama Pemilik Cafe"></td>
