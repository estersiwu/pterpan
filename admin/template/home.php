      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
				  ...
				  <h1>Selamat Datang, di Sistem Informasi "Bersua" Cafe</h1>
				  <hr>
				  ...
				  <?php 
					...
					<?php
							...
							<div class='alert alert-warning'>
								...
								<span class='pull-right'><a href='index.php?page=barang&stok=yes'>Tabel Menu <i class='fa fa-angle-double-right'></i></a></span>
							</div>
							";	
						}
					?>
					  ...
					  <div class="col-md-3">
                      		<div class="panel panel-primary">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Nama Menu</h5>
                      			</div>
                      			<div class="panel-body">
									<center><h1><?php echo number_format($hasil_barang);?></h1></center>
								</div>
								<div class="panel-footer">
									<h4 style="font-size:15px;font-weight:700;"><a href='index.php?page=barang'>Tabel Menu <i class='fa fa-angle-double-right'></i></a></h4>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-success">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Stok</h5>
                      			</div>
                      			<div class="panel-body">
                      ...
                      <!-- STATUS PANELS -->
                      	...
                      	<div class="col-md-3">
                      		<div class="panel panel-danger">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Kategori</h5>
                      			</div>
                      			<div class="panel-body">
